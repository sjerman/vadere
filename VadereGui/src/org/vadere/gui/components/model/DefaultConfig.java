...
public class DefaultConfig {
  ...
  private Color sourceColor =
      new Color(0.3333333333333333f, 0.6588235294117647f, 0.40784313725490196f);
  private Color targetColor =
      new Color(0.8666666666666667f, 0.51764705882352946f, 0.32156862745098042f);
  ...
  private Color stairColor =
      new Color(0.5058823529411764f, 0.4470588235294118f, 0.6980392156862745f);
  private Color pedestrianColor =
      new Color(0.2980392156862745f, 0.4470588235294118f, 0.7901960784313725f);
  ...
  private double aerosolCloudMaxPathogenConcentration; // pathogen concentration that corresponds to
  // aerosolCloudAlphaMax
  ...
  /**
   * Use this color palette: https://www.color-hex.com/color-palette/38840 Watch out: The user
   * cannot change these colors currently!
   */
  ...
  public Color getAerosolCloudColor() {
    return aerosolCloudColor;
  }

  public int getAerosolCloudAlphaMax() {
    return aerosolCloudAlphaMax;
  }

  public double getAerosolCloudMaxPathogenConcentration() {
    return aerosolCloudMaxPathogenConcentration;
  }

  public Color getDropletsColor() {
