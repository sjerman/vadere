...
public class VadereCommandHandlerTest extends CommandHandlerTest {
  ...
  public void process_getAllStimulusInfos() throws IOException {
    ...
    String elementID = "-1";
    String dataPath = "src/test/resources/stimulusInfoData.json";
    String retVal;
    try {
    ...
    TraCIGetCommand cmd =
        (TraCIGetCommand)
            getFirstCommand(TraCIGetCommand.build(TraCICmd.GET_VADERE_VALUE, varID, elementID));
    RemoteManager rm =
  ...
  public void process_addTargetChanger() {
    ...
    TraCIDataType varType = var.type;
    String elementID = "-1";
    String dataPath = "src/test/resources/targetChangerData.json";
    String data = "";
    try {
    ...
    TraCISetCommand cmd =
        (TraCISetCommand)
            getFirstCommand(
                TraCISetCommand.build(TraCICmd.SET_VADERE_STATE, elementID, varID, varType, data));
    RemoteManager rm =
        new TestRemoteManager() {
          @Override
          protected void mockIt() {
