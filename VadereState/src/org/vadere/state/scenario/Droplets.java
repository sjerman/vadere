...
public class Droplets extends ParticleDispersion {
  ...
  public static VShape createTransformedDropletsShape(
      VPoint origin, Vector2D direction, double radius, double centralAngleInDeg) {
    VPolygon shape;
    ...
    for (double angle = 0.0;
        angle <= centralAngleInRad;
        angle += centralAngleInRad / numberOfCircularSections) {
