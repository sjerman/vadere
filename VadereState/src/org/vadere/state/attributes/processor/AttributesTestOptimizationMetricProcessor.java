...
public class AttributesTestOptimizationMetricProcessor extends AttributesTestProcessor {
  ...
  /**
   * Following have to be fulfilled (i.e. the mean has to be below this. If the mean increases the
   * value, the processor will fail.
   */
  ...
  /**
   * These are just for information and reference -- there is a print out the console that compares
   * these the statistics.
   */
