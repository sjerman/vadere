...
public class DistanceRecommendation extends Stimulus {
  ...
  private double cloggingTimeAllowedInSecs =
      5.0; // time in seconds after agents fall back to default behavior in case of clogging

  // Default constructor required for JSON de-/serialization.
  public DistanceRecommendation() {
    super();
  }
  ...
  public DistanceRecommendation(
      double time, double socialDistance, double cloggingTimeAllowedInSecs) {
    super(time);
  ...
  public double getCloggingTimeAllowedInSecs() {
    return cloggingTimeAllowedInSecs;
  }
