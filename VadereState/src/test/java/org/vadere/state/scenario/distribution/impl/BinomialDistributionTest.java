...
public class BinomialDistributionTest extends VadereDistributionTest {
  ...
  @Mock org.apache.commons.math3.distribution.BinomialDistribution distMock;
  ...
  protected VDistribution<?> getDistributionUnderTest() throws Exception {
    ...
    PowerMockito.whenNew(org.apache.commons.math3.distribution.BinomialDistribution.class)
        .withAnyArguments()
        .thenReturn(distMock);
