...
public class TargetVersionV0_8 extends SimpleJsonTransformation {
  ...
  private void migrate_measurementArea(JsonNode scenarioFile, JsonNode p)
    ...
    if (!measurementArea.isMissingNode()) {
      ...
      int measurementAreaId =
          transformShapeToMeasurementArea(scenarioFile, measurementArea, mapper);
  ...
  public JsonNode applyMeasurementAreaType1(JsonNode scenarioFile) throws MigrationException {
    ...
    for (String type : processorTypes) {
      ArrayList<JsonNode> processor = getProcessorsByType(scenarioFile, type);
  ...
  public JsonNode applyMeasurementAreaType2(JsonNode scenarioFile) throws MigrationException {
    String[] processorTypes = {
      ...
      // 2
      // (voronoiArea -> voronoiMeasurementAreaId)
    };
  ...
  public static void main(String[] arg) throws Exception {
    BufferedReader r =
        new BufferedReader(
            new FileReader(
                "/home/lphex/hm.d/vadere/Scenarios/ModelTests/TestOSM/scenarios/rimea_04_flow_osm1_125_h.scenario"));
