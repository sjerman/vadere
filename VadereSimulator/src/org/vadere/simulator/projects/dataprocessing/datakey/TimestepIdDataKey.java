...
/**
 * @author Simon Rahn Data key for time dependent custom data aggregators when the keys timestep
 *     and/or IdDataKey are not enough. If applied to pedestrians ids use TimestepPedestrianIdKey
 *     instead.
 */
...
public class TimestepIdDataKey implements DataKey<TimestepIdDataKey> {
  ...
  public String toString() {
    return "TimestepIdDataKey{" + "timestep=" + timestep + ", id=" + id + '}';
  }
